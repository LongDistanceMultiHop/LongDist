...
parser.add_argument('--point_state_dict_path', type=str, default='',
                    help='Path to the rl network state dict (default: '')')
...
# Evaluation
parser.add_argument('--eval_by_length_type', action='store_true',
                    help='compute evaluation metrics for per length separately (default: False)')

# record log
parser.add_argument('--log_file',type=str, default=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data'),
                    help='filename: record log')
#attention
parser.add_argument('--using_attention', action='store_true',
                    help='Using attention (default: False)')
#long short mix
parser.add_argument('--long_short_term', type=int, default=0,
                    help='mix 0 long 1 short 2')

#attention
parser.add_argument('--using_embedding_test', action='store_true',
                    help='Using attention (default: False)')
