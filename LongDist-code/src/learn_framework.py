...
class LFramework(nn.Module):
    def __init__(self, args, kg, mdl):
        ...
        self.using_embedding_test=args.using_embedding_test
    ...
    def run_train(self, train_data, dev_data):
        ...
        for epoch_id in range(self.start_epoch, self.num_epochs):
            ...
            if self.rl_variation_tag.startswith('rs')or self.rl_variation_tag.startswith('fusion'):
            ...
            with open(self.logfile+'loss','a') as logf:
                logf.write('Epoch {} {}\n'.format(epoch_id, np.mean(batch_losses)))
            logf.close()
            if entropies:
            ...
            if self.run_analysis or (epoch_id >= 0 and epoch_id % self.num_peek_epochs == 0):
                ...
                metrics = mrr
                with open(self.logfile+'eval', 'a') as logf:
                    logf.write('{},{},{},{},{}\n'.format(hits_at_1, hits_at_3,hits_at_5,hits_at_10,mrr))
                logf.close()
